...
//-------------------------------------------------------------------------------------------------//
    if(($acciones=="municipios")){
        ...
        if (($estado!="")&&($estado!="null")){
            echo '<select name="codmun" id="codmun" onChange="cargarContenidoParroquia();" onClick="cargarContenidoParroquia();" class="form-control">';
...
//                    mysql_free_result($ejec_consultax1);	
            ...
            echo '<select name="codmun" id="codmun" style="width:180px"  onChange="cargarContenidoParroquia();" onClick="cargarContenidoParroquia();" class="form-control">';
            echo '<option value="">----</option>';
            echo '</select>';
    ...
    if(($acciones=="parroquias")){
        ...
        if (($municipio!="")&&($estado!="")){
            echo '<select name="codpar" id="codpar" onChange="cargarContenidoComunidad();" onClick="cargarContenidoComunidad();" class="form-control">';
            echo '<option value="">----</option>';
...
//			mysql_free_result($ejec_consultax1);	
            ...
            echo '<select name="codpar" id="codpar" style="width:180px" onChange="cargarContenidoComunidad();" onClick="cargarContenidoComunidad();" class="form-control">';
            echo '<option value="">----</option>';
            echo '</select>';			
        }	
    }
    ...
    if(($acciones=="comunidades")){
        ...
        if (($municipio!="")&&($estado!="")&&($parroquia!="")){
            echo '<select name="codcom" id="codcom" class="form-control">';
            echo '<option value="">----</option>';
            ...
            echo '</select>';
            echo '<a href="javascript: ue_comunidad_add();">';
            echo '<img src="images/agregar.png" alt="Buscar" title="Registrar Responsable de MIN COMUNA" width="20" height="20" border="0">';
            echo '</a>  ';
            pg_free_result($ejec_consultax1);	
        }else {
            echo '<select name="codcom" id="codcom" class="validate[required]" style="width:180px" class="form-control">';
            echo '<option value="">----</option>';
            echo '</select>';			
        }	
    }
...
//			mysql_free_result($ejec_consultax1);	
    ...
    if(($acciones=="tramites")){
        ...
        if (($categoria!="")){
            echo '<select name="cod_tramite" id="cod_tramite" class="form-control"  onchange="cargarContenidoTramiteUnidadSol();">';
            echo '<option value="">----</option>';
    ...
    if(($acciones=="tramites_categorias_unidades")){
        ...
        if (($categoria!="" && $tramite!="")){
            echo '<select name="cod_unidad" id="cod_unidad" class="form-control" >';
            echo '<option value="">----</option>';
    ...
    if(($acciones=="tramites_unidades_categorias")){
        ...
        if (($unidad!="" && $categoria!="")){
            ...
            echo '</select>
                  <a href="javascript: ue_vehiculo_add();"><img src="images/group_add.png" alt="Buscar" title="Registrar Vehiulo" width="15" height="15" border="0"></a>';
            pg_free_result($ejec_consultax1);	
        }else {
            echo '<select name="cod_tramite" id="cod_tramite" class="validate[required]" style="width:180px" >';
            echo '<option value="">----</option>';
        ...
        echo '<div id="vehiculos" >
                    <select name="cod_vehiculo" id="cod_vehiculo" class="validate[required]"  >
                        <option  selected="selected" value="">Seleccione el Vehículo</option>';
                            ...
                            $consultax2="SELECT * from vehiculo_solicitante where cedula_rif='$cedula_rif_buscar'";
            ...
            if (($codigo_consultar!="")&&($codigo_consultar!="null")){
                ...
                if ($resultados[0]){
                    ...
                    echo '<input id="stock" name="stock" value="'.$resultados[stock].'" type="hidden">
                          <input id="status_stock" name="stock_stock" value="'.$resultados[status_stock].'" type="hidden">
