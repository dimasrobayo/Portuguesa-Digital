...
//        echo "<script type='text/javascript'>window.location.href='index.php'</script>";
    ...
    if (isset($_POST[save])) {
        ...
        $query="UPDATE usuarios SET nombre_usuario='$nombre', apellido_usuario='$apellido', usuario='$usuario', cod_unidad=$unidad, solicitar_punto=$solicitar_punto, recibir_orden=$recibir_orden, email_usuario='$email_usuario', telefono_movil='$telefono_movil', id_estado_mayor='$id_estado_mayor' WHERE cedula_usuario='$cedula';";
        $result = pg_query($query)or die(pg_last_error());
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="form-group">
                                ...
                                <select id="id_estado_mayor" name="id_estado_mayor" size="0" class="form-control">
                                    <option value="<?php echo $result_usuarios[id_estado_mayor]; ?>">--SELECCIONE PARA MODIFICAR--</option>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="04141234567" title="Ej.: 04141234567" id="telefono_movil" type="text" name="telefono_movil" size="15" value="<?php echo $result_usuarios[telefono_movil]; ?>" maxlength="15"/>
                            </div>

                            <div class="form-group">
                                <label>CORREO ELECTR&Oacute;NICO</label>
                                <input class="form-control" placeholder="minombre@ejemplo.com" title="Ej.: minombre@ejemplo.com" type="text" id="email_usuario" name="email_usuario" value="<?php echo $result_usuarios[email_usuario]; ?>" size="50" maxlength="50"/> 
                            </div>
