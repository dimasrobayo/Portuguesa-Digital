...
//        echo "<script type='text/javascript'>window.location.href='index.php'</script>";
    ...
    $datos_consultaT =pg_query("SELECT * FROM inbox") or die(pg_last_error());
    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-heading">
                ...
                <div style="float:right;">
                    <a href="reportes/imprimir_recibidos.php" target="_blank" class="btn btn-default btn-warning">Imprimir</a>
                </div>
                <div style="float:right;">
                    <a href="index2.php?view=recibido_drop" class="btn btn-default btn-danger">Borrar</a>
                </div>
                <h4 class="text-primary"><strong> SMS RECIBIDOS </strong></h4> 
            </div>
