...
if (isset($_GET['id'])){
	...
	else 
	{
		...
		$result_borrar=pg_query("SELECT drop_inbox($datos_borrar)") or die(pg_last_error());
		pg_close();
	}
}
?> 
							...
							<div style="float:right;">
								<div class="icon">
									<a href="index2.php?type=recibidos">
										<img src="images/sms_recibidos.png" alt="salir" align="middle"  border="0" />
