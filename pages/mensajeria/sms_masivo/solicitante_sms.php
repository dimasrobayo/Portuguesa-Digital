                ...
                <div class="row">
                    ...
                    <input type="hidden" id="telefono_movil" name="telefono_movil"  value="<?php echo $result_solicitantes['telefono_movil'];?>" />
                        <div class="col-lg-12">
                            ...
                            <input  class="btn btn-default" type="button" onclick="javascript:window.location.href='?view=solicitante_load_view<?php echo '&cedula_rif='.substr_replace($cedula_rif,'-',1,0);?>'" value="Cerrar" name="cerrar" /> 
                        </div>
                    </form>
                </div>
            </div>
