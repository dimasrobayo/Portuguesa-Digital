    ...
    <ul class="nav" id="side-menu">
        ...
        <li>
            ...
            <ul class="nav nav-second-level">
                ...
                <li>
                    ...
                    <ul class="nav nav-third-level">
                        <li>
                            <a href="index2.php?view=est_ordenes">General de Estado Mayor</a>
                        </li>

                        <li>
                            <a href="index2.php?view=ordenes_unidad">Estado Mayor</a>
                        </li>

                        <li>
                            <a href="index2.php?view=ordenes_mensuales">Estado Mayor por Fecha</a>
                        </li>
                    </ul>
                </li>
            </ul>
        ...
        <li>
            ...
            <ul class="nav nav-second-level">
                ...
                <?php if ($result_permisos[administra_estado_mayor]==1){ ?>
                    <li>
                        <a href="#">
                        Administrar Estado Mayor
                        <span class="fa arrow"></span>
                        </a>

                        <ul class="nav nav-second-level">
                            <?php if ($result_permisos[gestiona_estado_mayor]==1){ ?>
                                <li>
                                    <a href="index2.php?view=estado_mayor">Estado Mayor</a>
                                </li>
                                
                                <li>
                                    <a href="index2.php?view=estado_mayor">Planificacion / Ejecución</a>
                                </li>
                                
                                <li>
                                    <a href="index2.php?view=informe_semanal_adm">Informe Semanal</a>
                                </li>
                            <?php } ?>
                        </ul>
                    </li>
        ...
        <li>
            ...
            <ul class="nav nav-second-level">
                <?php if ($result_permisos[gestiona_estado_mayor]==1){ ?>
                    <li>
                        <a href="index2.php?view=planificacion">Planificación</a>
                    </li>

                    <li>
                        <a href="index2.php?view=ejecucion">Ejecucion</a>
                    </li>
                    
                    <li>
                        <a href="index2.php?view=informe_semanal">Informe Semanal</a>
                    </li>
                <?php } ?>
            </ul>
        </li>
        ...
        <li>
            <a href="index2.php?view=pagos_peaje_view">
                <i class="fa fa-calendar-check-o"></i> 
                ADM Pagos Peajes
            </a>
            <!-- /.nav-second-level -->
        ...
        <li>
            ...
            <ul class="nav nav-second-level">
                <li>
                    <a href="index2.php?view=solicitante_mantenimiento">
                        Mantenimiento de Tickets
                    </a>
                </li>
                
                <li>
                    <a href="index2.php?view=solicitante_mantenimiento_phone">
                        Mantenimiento de Solicitantes
                    </a>
                </li>

                <li>
                    <a href="index2.php?view=usuarios_permisos_masivos">
                        Permisos por Grupos de Usuario
                    </a>
                </li>
            </ul>
            <?php } ?>
