...
if (isset($_POST[save])){
    ...
    $fields = array(
        "KeyID"             => "BA9B83CE-1028-4C4F-881C-4FC9EB0AA981", //required
            ...
            <div class="panel-heading"><h4>Respuesta de la Transacción</h4></div>
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <a href="?view=peaje" class="btn btn-primary" name="Continuar"> Continuar </a>
                        </div>
                    </div>
                </div>
            </div>
        </div>';
        $query="insert into peajes (cedula_rif, tipo_operacion, monto_operacion) values ('$cedula_usuario', '$tipo_operacion', '$Amount')";
...
<?php }else{ ?>   <!-- Mostrar formulario Original --> 
            ...
            <div class="panel-heading">
                <h4 class="text-primary">
                    <strong> SERVICIO DE PEAJE: <?php echo $_SESSION['username']?></strong>
                </h4>
            </div>
            ...
            <div class="panel-body">
                <div class="row">
                    <form method="POST" action="<?php echo $pagina?>" id="QForm" name="QForm" enctype="multipart/form-data">
                        ...
                        <input class="form-control" type="hidden" id="id_deuda" name="id_deuda" value="<?php echo $resultados1[id_peaje]; ?>" />
                        <div class="col-lg-12">
