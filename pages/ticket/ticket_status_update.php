<?php
    ...
    if (isset($_POST[save])){//se resive los datos a ser modificados
        ...
        $sms=$resultados_empresa[sms_programar_ticket];
        // FIN CONSULTA DE EMPRESA

        $query="insert into detalles_ticket (cod_ticket,cod_estado_tramite,cod_unidad,fecha_cita_programada,hora_cita_programada,situacion_actual,actuacion,monto_autorizado,observaciones,user_login) values ('$cod_ticket','$cod_estado_tramite','$cod_unidad','$fecha_cita_programada','$hora_cita_programada','$situacion_actual','$actuacion','$monto_autorizado','$observaciones','$user') RETURNING cod_detalle_ticket";
        $result = pg_query($query)or die(pg_last_error());
            ...
            if($send_email==1){
                if($resultados_ticket[email]!="") {
                    ...
                    $body="Saludos de la Oficina de Atención al Portugueseño,<br><br> ".
                            " Se ha Actualizado su Solicitud en el Sistema de Atención Al Portugueseño (AAP). <br> ".
                    ...
                    <form method="POST" action="<?php echo $pagina?>" id="QForm" name="QForm" enctype="multipart/form-data">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control"  name="situacion_actual" id="situacion_actual" cols="84" rows="2"  >SE PROGRAMO  CITA PARA LA ATENCIÓN DEL REQUERIMIENTO</textarea>
                            </div>
