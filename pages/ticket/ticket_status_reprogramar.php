            ...
            <div class="panel-body">
                <div class="row">
                    <form method="POST" action="<?php echo $pagina?>" id="QForm" name="QForm" enctype="multipart/form-data">
                        ...
                        <div class="col-lg-6">
                            <h1>REPROGRAMAR TICKET</h1>
                            <div class="form-group">
                                <label>FECHA DE CITA REPROGRAMADA</label>
                                <div class="input-group date" id="datetimepicker1">
                                    <input type='date' class="form-control" id='fecha_cita_programada' name="fecha_cita_programada" value="<?php echo $resultados_subticket[fecha_cita_programada];?>" />
                            ...
                            <div class="form-group">
                                <label>HORA DE CITA REPROGRAMADA</label>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="situacion_actual" id="situacion_actual" cols="84" rows="2"  >SE REPROGRAMO  CITA PARA LA ATENCIÓN DEL REQUERIMIENTO</textarea>
                            </div>
