...
//        $hora_desde=date("H:i", mktime($thorad,$tminutosd,0));
        ...
        $sms=$resultados_empresa[sms_cancelar_ticket];
                    ...
                    <form method="POST" action="<?php echo $pagina?>" id="QForm" name="QForm" enctype="multipart/form-data">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control"  name="situacion_actual" id="situacion_actual" cols="84" rows="2"  >SU SOLICITUD NO PUEDE SER COMPLETADA CON EXITO</textarea>
                            </div>
