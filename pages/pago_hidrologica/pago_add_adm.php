            ...
            <div class="panel-heading"><h4>Respuesta de la Transacción</h4></div>
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <a href="?view=pagos_hidrologica_view" class="btn btn-primary" name="Continuar"> Continuar </a>
                        </div>
                    </div>
                </div>
            </div>
...
<?php }else{ ?>   <!-- Mostrar formulario Original --> 
            ...
            <div class="panel-heading">
                <h4 class="text-primary"><strong> SERVICIO DE LA HIDROLOGICA: <?php echo $resultados1[nombre_usuario] .' ' .$resultados1[apellido_usuario];?> - <?php echo $resultados1[periodo_facturado]; ?> </strong></h4>
            </div>
