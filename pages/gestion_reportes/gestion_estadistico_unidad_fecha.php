...
<div align="center" class="centermain">
    <div class="main">  
        ...
        <form id="QForm" name="QForm" method="POST" action="reportes/imprimir_estadistico_ticket_unidad_fecha.php" enctype="multipart/form-data" target="_Blank">
            <input type="hidden" id="cod_unidad" name="cod_unidad"  value="<?php echo $_SESSION[cod_unidad];?>" />
