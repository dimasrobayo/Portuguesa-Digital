    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-heading">
                REPORTE DE SOLICITUDES POR CATEGORIA
            </div>
...
<?php if ((isset($_POST[save])) and ($error=="bien")){  ?> <!-- Mostrar Mensaje -->
            <div class="form-group" align="center"> 
                <h3 class="info">   
                    <font size="2">                     
                        <h1>Datos registrados con &eacute;xito 
                        <br />
                        <script type="text/javascript">
...
<?php   }else{  ?>   <!-- Mostrar formulario Original --> 
            ...
            <div class="panel-body">
                <div class="row">    
                    <form id="QForm" name="QForm" method="POST" action="reportes/imprimir_lista_ticket_unidad.php" enctype="multipart/form-data" target="_Blank">
                        <div class="col-lg-12">
                            <div class="form-group" autofocus="true">
                                ...
                                <select name="cod_unidad" id="cod_unidad" class="form-control">
                                    ...
                                    <?php 
                                        $consulta_sql=pg_query("SELECT cod_unidad, nombre_unidad FROM unidades order by nombre_unidad");
                            ...
                            <button type="submit" class="btn btn-default" name="save">REPORTE</button>
