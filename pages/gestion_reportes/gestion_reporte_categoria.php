...
<?php	}else{ 	?>   <!-- Mostrar formulario Original --> 
            ...
            <div class="panel-body">
                <div class="row">    
                    <form id="QForm" name="QForm" method="POST" action="reportes/imprimir_lista_ticket_categoria.php" enctype="multipart/form-data" target="_Blank">
                        <div class="col-lg-12">
                            <div class="form-group" autofocus="true">
                                ...
                                <select name="categoria" id="categoria" class="form-control">
                                    ...
                                    <?php 
                                        $consulta_sql=pg_query("SELECT cod_categoria, descripcion_categoria FROM categorias order by descripcion_categoria");
