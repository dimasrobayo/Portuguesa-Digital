    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-heading">
                REPORTE DE SOLICITUDES POR TIPO DE TRAMITE
            </div>
...
<?php	}else{ 	?>   <!-- Mostrar formulario Original --> 
            ...
            <div class="panel-body">
                <div class="row">
                    <form id="QForm" name="QForm" method="POST" action="reportes/imprimir_lista_ticket_tipo_tramite.php" enctype="multipart/form-data" target="_Blank">
                        <div class="col-lg-12">
