    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-heading">
                <h4 class="text-primary"><strong> ESTADISTICA DE ATENCION POR USUARIO </strong></h4>
            </div>
                
            <div class="panel-body">
                <div class="row">
                    <form method="POST" action="?view=est_ord_unidad" id="QForm" name="QForm" enctype="multipart/form-data">
                        <div class="col-lg-12">
                            <div class="form-group" autofocus="true">
                                <label>SELECCIONA LA USUARIOS</label>
                                <select name="cedula_usuario" id="cedula_usuario" class="form-control">
                                    <option selected="selected" value="">---</option>
                                    <?php 
                                        $consulta_sql=pg_query("SELECT * FROM usuarios where recibir_orden=1 order by nombre_usuario");
