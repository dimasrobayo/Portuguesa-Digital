    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-heading">
                <h4 class="text-primary"><strong> ESTADISTICA DE ATENCION MENSUAL </strong></h4>
            </div>
                
            <div class="panel-body">
                <div class="row">
                    <form method="POST" action="?view=est_aten_mensual" id="QForm" name="QForm" enctype="multipart/form-data">
                        <div class="col-lg-12">
                            <div class="">
                                <div class="form-group col-lg-6" autofocus="true">
                                    ...
                                    <select name="month" id="month" class="form-control">
                                        <?php 
                                        $consulta_sql=pg_query("SELECT date_part('month',fecha_registro) AS year FROM ticket  group by date_part('month',fecha_registro) order by date_part('month',fecha_registro) ASC");                                
