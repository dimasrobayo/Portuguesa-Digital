...
//        echo "<script type='text/javascript'>window.location.href='index.php'</script>";
    ...
    $datos_consultaT = pg_query("SELECT * FROM ente_publico order by id_ente") or die(pg_last_error());
    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div style="float:right;">
                ...
                <div style="float:right;">
                        <a href="index2.php?view=ente_publico_add" class="btn btn-default btn-primary">Agregar</a>
                </div>
                <h4 class="text-primary"><strong> ENTES PUBLICOS </strong></h4>
            </div>
