    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-heading">
                <h4 class="text-primary"><strong> RESPONDER PUNTO DE CUENTA </strong></h4>
            </div>
                ...
                <div class="row">
                    <form method="POST" action="<?php echo $pagina?>" id="QForm" name="QForm" enctype="multipart/form-data">
                        ...
                        <div class="col-lg-12">
                            ...
                            <button type="submit" class="btn btn-default btn-primary" name="save" value="1" >APROBAR</button>
                            <button type="submit" class="btn btn-default btn-danger" name="save" value="2" >NEGAR</button>
                            <button type="submit" class="btn btn-default btn-warning" name="save" value="3" >DIFERIDO</button>
