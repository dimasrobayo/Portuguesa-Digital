...
if (isset($_GET['id_estado_mayor'])){
	$datos_borrar= $_GET['id_estado_mayor'];
	...
	if ($total_registros == 1){
		$error="malo";	
            ...
            $error="bien";
            $result_borrar=pg_query("DELETE FROM estado_mayor WHERE id_estado_mayor=$datos_borrar") or die(pg_last_error());
            pg_close();
	}
}
?> 
    ...
    <div class="col-lg-12">
        <div class="panel panel-default"> 
            <div class="panel-heading">
                <h4 class="text-primary"><strong> BORRAR ESTADO MAYOR </strong></h4>
            </div>
