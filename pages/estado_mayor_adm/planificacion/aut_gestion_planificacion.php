    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-heading">
                ...
                <h4 class="text-primary"><strong> PLANIFICACION - ESTAD MAYOR </strong></h4>                              
            </div>
...
?>
                    ...
                    <tr class="gradeA">
                        ...
                        <td align="center">
                            <a onclick="return confirm('Esta seguro que desea eliminar el registro?');" href="index2.php?view=planificacion_drop_adm&id_planificacion=<?php echo $resultados[id_planificacion]?>" title="Pulse para eliminar el registro">
                                <img border="0" src="images/borrar28.png" alt="borrar">
                            </a>

                            <a href="index2.php?view=planificacion_update_adm&id_planificacion=<?php echo $resultados[id_planificacion]?>" title="Pulse para Modificar Los Datos">
