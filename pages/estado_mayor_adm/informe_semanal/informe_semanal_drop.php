...
if (isset($_GET['id_informe'])){
	...
	if ($total_registros == 1){
		$error="malo";	
            ...
            $error="bien";
            $result_borrar=pg_query("DELETE FROM em_informe_semanal WHERE id_informe=$datos_borrar") or die(pg_last_error());
            pg_close();
	}
}
?> 
    ...
    <div class="col-lg-12">
        <div class="panel panel-default"> 
            <div class="panel-heading">
                <h4 class="text-primary"><strong> BORRAR INFORME SEMANAL </strong></h4>
            </div>
