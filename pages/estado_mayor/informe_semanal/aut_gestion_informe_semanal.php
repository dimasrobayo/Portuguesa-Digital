...
//        echo "<script type='text/javascript'>window.location.href='index.php'</script>";
    ...
    $datos_consulta = pg_query("SELECT * FROM estado_mayor, em_informe_semanal, usuarios where em_informe_semanal.id_estado_mayor = estado_mayor.id_estado_mayor and usuarios.id_estado_mayor = estado_mayor.id_estado_mayor and usuarios.cedula_usuario = '$cedula_usuario' order by em_informe_semanal.id_informe") or die(pg_last_error());
?>
...
?>
                    ...
                    <tr class="gradeA">
                        ...
                        <td align="center"> 
                            <a onclick="return confirm('Esta seguro que desea eliminar el registro?');" href="index2.php?view=informe_semanal_drop&id_informe=<?php echo $resultados[id_informe];?>" title="Pulse para eliminar el registro">
                                <img border="0" src="images/borrar28.png" alt="borrar">
                            </a>
                            <a href="index2.php?view=informe_semanal_update&id_informe=<?php echo $resultados[id_informe];?>" title="Pulse para Modificar los datos registrados">
