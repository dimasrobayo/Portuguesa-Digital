                    ...
                    <tr class="gradeA">
                        ...
                        <td align="center"> 
                            ...
                            <a href="index2.php?view=planificacion_adm&id_estado_mayor=<?php echo $resultados[id_estado_mayor];?>" title="Pulse para Supervidar Planificacion">
                                <img border="0" src="images/planificacion.png" alt="planificacion">
                            </a>
                            <a href="index2.php?view=ejecucion_adm&id_estado_mayor=<?php echo $resultados[id_estado_mayor];?>" title="Pulse para Reportar Ejecucion">
                                <img border="0" src="images/control.png" alt="reportar">
                            </a>
                            <a href="reportes/imprimir_estado_mayor.php?id_estado_mayor=<?php echo $resultados[id_estado_mayor]?>" title="Pulse para Generar Reporte General" target="true">
                                <img border="0" src="images/printer28.png" alt="borrar">
                            </a>
                        </td>
                    </tr>
