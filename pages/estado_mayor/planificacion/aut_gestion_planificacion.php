    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-heading">
                ...
                <h4 class="text-primary"><strong> PLANIFICACION - ESTADO MAYOR </strong></h4>                              
            </div>
...
?>
                    ...
                    <tr class="gradeA">
                        ...
                        <td align="center">
                            <?php
                                if($resultados[status_planificacion]==0){
                                    echo '<a onclick='."return confirm('Esta seguro que desea eliminar el registro?');".' href="index2.php?view=planificacion_drop&id_planificacion='.$resultados[id_planificacion].'" title="Pulse para eliminar el registro">
                                        <img border="0" src="images/borrar28.png" alt="borrar">
                                    </a>';

                                    echo '<a href="index2.php?view=planificacion_update&id_planificacion='.$resultados[id_planificacion].'" title="Pulse para Modificar Los Datos">
                                        <img border="0" src="images/modificar.png" alt="borrar">
                                    </a>';

                                    echo '<a href="index2.php?view=notificar_planificacion&id_planificacion='.$resultados[id_planificacion].'&status_planificacion=1" title="Pulse para Dar Notificar">
