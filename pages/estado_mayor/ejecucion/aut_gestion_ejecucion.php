                    ...
                    <tr class="gradeA">
                        ...
                        <td align="center">
                            <?php
                                ...
                                if ($resultado_ejecutado[status_ejecutado] == 0){
                                    ...
                                    echo '<a href="index2.php?view=notificar_ejecucion&id_planificacion='.$resultados[id_planificacion].'&status_ejecutado=1" title="Pulse para Dar Notificar">
