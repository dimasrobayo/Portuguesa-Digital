...
<?php 
    if (isset($_POST[save])) {
        ...
        $monto_ejecutado = ($_POST['monto_ejecutado']);
                    ...
                    <form method="POST" action="<?php echo $pagina?>" id="QForm" name="QForm" enctype="multipart/form-data">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="monto_ejecutado" name="monto_ejecutado" value="0,00">
                            </div>
                        </div>

                        <div class="col-lg-12">
                            <button type="submit" id="save" name="save" class="btn btn-default btn-primary">Guardar</button>
                            <input  class="btn btn-default" type="button" onclick="javascript:window.location.href='?view=planificacion'" value="Cerrar" name="cerrar" readonly="true" />  
                        </div>
                    </form>
                </div>
            </div>
