<?php
    ...
    $pdf->Cell(90,4,utf8_decode('NOMBRE DEL SOLICITANTE'),1,0,'C',0);
    $pdf->Cell(0,4,utf8_decode('TELEFONO'),1,1,'C',0);
    
    
    $pdf->SetFontSize(11);
    $pdf->Cell(25,5,utf8_decode(str_pad($resultados_ticket['cod_ticket'],10,"0",STR_PAD_LEFT)),1,0,'C',0);
    $pdf->SetFont('');
    $pdf->Cell(25,5,utf8_decode(date_format(date_create($resultados_ticket['fecha_registro_ticket']), 'd/m/Y')),1,0,'C',0);
    $pdf->Cell(30,5,utf8_decode(substr_replace($resultados_ticket['cedula_rif'],'-',1,0)),1,0,'C',0);
    $pdf->Cell(90,5,utf8_decode($resultados_ticket['nombre_solicitante']),1,0,'C',0);
    $pdf->Cell(0,5,utf8_decode($resultados_ticket['telefono_movil']),1,1,'C',0);
    ...
    $pdf->SetFont('Arial','B',16);
    $pdf->Image('./logo/logo.jpg',10,135,'32','','jpg','http://www.alcaldiaguanare.gob.ve');
