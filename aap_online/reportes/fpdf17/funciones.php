...
//	 
	 ...
	 $this->SetY(-15);    
	 $this->SetFont('Arial','',8);    
	 $this->Cell(60,5,utf8_decode('Generado el '.$dias.' de '.$mes.' del '.$anno.'.'),0,0,'L');	
	 
         //Posicion: a 1,5 cm del final
	 $this->SetY(-15);
         $this->Cell(60);
	 $this->SetFont('Arial','',8);    
	 $this->Cell(95,5,utf8_decode(''),0,0,'C');	
	 
	 //Posicion: a 1,5 cm del final
	 $this->SetY(-15);
         $this->Image('./logo/hannah.jpg',110,265,'','','jpg','http://www.vpa.unellez.edu.ve');
	 $this->Cell(155);
	 $this->SetFont('Arial','',8);    
