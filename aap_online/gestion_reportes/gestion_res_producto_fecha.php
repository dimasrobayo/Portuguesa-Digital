...
<div align="center" class="centermain">
    <div class="main">  
        ...
        <form id="QForm" name="QForm" method="POST" action="reportes/imprimir_lista_producto_fechas.php" enctype="multipart/form-data" target="_Blank">
            <table class="adminform" border="0" width="100%">
                <tr>
                    <th colspan="2" align="center">
                        <img src="images/iconos/ver_detalle.png" width="16" height="16" alt="Nuevo Registro">
                        LISTADO DE PRODUCTOS FACTURADOS POR FECHA
                    </th>
                </tr>
                    ...
                    <td colspan="2">
                        <table class="borded" border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tbody>
                                ...
                                <tr>
                                    <td>PRODUCTO A REPORTAR</td>
                                    <td >
                                        <input type="hidden" id="codigo_concepto" name="codigo_concepto"  value="" />
                                        <input type="text" readonly="true" id="descripcion_concepto" name="descripcion_concepto" value="" onkeyup="" size="50" maxlength="50"/>
                                        <a href="javascript: ue_buscarconcepto();"><img src="images/busqueda.png" alt="Buscar" title="Buscar Concepto" width="15" height="15" border="0"></a>
                                    </td>
                                </tr>
                            </tbody>
                        </table>	
...
<script type="text/javascript" >
    function ue_buscarconcepto()	{
        document.QForm.codigo_concepto.value="";											
        document.QForm.descripcion_concepto.value="";											
        window.open("gestion_reportes/concepto_load.php","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=550,height=310,left=50,top=50,location=no,resizable=no");
    } 
</script>
