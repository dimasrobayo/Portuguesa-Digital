<?php
    ...
    # Perform the query
    $query = "SELECT codigo_concepto, nombre_concepto from concepto_factura WHERE codigo_concepto::text ILIKE  '%$texto_buscar%' OR nombre_concepto::text ILIKE  '%$texto_buscar%' ORDER BY nombre_concepto ASC LIMIT 10";
