...
<div align="center" class="centermain">
    <div class="main">
        ...
        <table class="partido_politico" width="100%">
            <tr>
                <th>
                    PARTIDO POLITICO:
                </th>
        ...
        <form method="POST" action="<?php echo $pagina?>" id="QForm" name="QForm" enctype="multipart/form-data">
            <table class="adminform" border="0" width="100%">
                ...
                <tr>
                    <td class="titulo" colspan="2" height="18"  align="left"><b>Datos del Ente Publico:</b></td>
                </tr>
                    ...
                    <td colspan="2">
                        <table class="borded" border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tbody>
                                <tr>
                                    <td width="15%" >
                                        PARTIDO POLITICO: <font color="Red">(*)</font>
                                    </td>

                                    <td>
					                    <input  type="text" id="partido_politico" name="partido_politico" value="<?php if ($error!='') echo $partido_politico;?>" class="validate[required] text-input" size="70" maxlength="70"/>
                                    </td>			
                                </tr>
                            </tbody>
                        </table>	
                ...
                <tr>
                    <td colspan="2" class="botones" align="center" >			
                        ...
                        <input  class="button" type="button" onclick="javascript:window.location.href='?view=partido_politico'" value="Cerrar" name="cerrar" />  
                    </td>													
                </tr> 
