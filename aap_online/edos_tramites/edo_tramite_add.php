            ...
            <table class="adminform" border="0" width="100%">
                <tr>
                    <th colspan="2" align="center">
                        ...
                        INGRESAR DATOS DEL ESTADO DE TRAMITE
                    </th>
                </tr>
                        ...
                        <table class="borded" border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <input  type="text" id="siglas" name="siglas" value="<?php if ($error!='') echo $siglas;?>" onkeyup="" class="validate[required] text-input" size="5" maxlength="5"/>			
                                    </td>			
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input  type="text" id="etramite" name="etramite" value="<?php if ($error!='') echo $etramite;?>" onkeyup="" class="validate[required] text-input" size="5" maxlength="5"/>			
                                    </td>			
                                </tr>
