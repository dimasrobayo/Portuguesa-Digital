            ...
            <table class="adminform" border="0" width="100%">
                <tr>
                    <th colspan="2" align="center">
                        ...
                        INGRESAR DATOS DEL ENTE PUBLICO
                    </th>
                </tr>
                        ...
                        <table class="borded" border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tbody>
                                <tr>
                                    ...
                                    <td>
					                    <input  type="text" id="ente_publico" name="ente_publico" value="<?php if ($error!='') echo $ente_publico;?>" class="validate[required] text-input" size="70" maxlength="70"/>
                                    </td>			
                                </tr>
                            </tbody>
                        </table>	
