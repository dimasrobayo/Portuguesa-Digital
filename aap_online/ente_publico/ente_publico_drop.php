...
//        echo "<script type='text/javascript'>window.location.href='index.php'</script>";
    ...
    if (isset($_GET['id_ente'])){
        $datos_borrar= $_GET['id_ente'];
        
        $query="SELECT * FROM ente_publico WHERE ente_publico.ente_publico ='$datos_borrar' AND ente_publico.ente_publico IN (SELECT ente_publico FROM solicitantes)";			
        ...
        if ($total_registros == 1){
            ...
            $result_borrar=pg_query("SELECT drop_ente_publico($datos_borrar)") or die(pg_last_error());
            pg_close();
        }
    }
?> 
