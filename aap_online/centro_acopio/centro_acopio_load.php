    ...
    if (isset($_POST[save])){
        if ($_POST['personvalue1']!="") {
            ...
            echo "<script type=\"text/javascript\">
                    opener.document.QForm.responsable.value='$cedula_rif';
                    opener.document.QForm.nombre_apellido.value='$resultado_cliente[nombre_solicitante]' + ' ' + '$resultado_cliente[apellido_solicitante]';
                    opener.document.QForm.tipo_solicitante.value='$resultado_cliente[descripcion_tipo_solicitante]';
                    opener.document.QForm.direccion.value='$resultado_cliente[direccion_habitacion]';
                    close();
                  </script>";
    ...
    //                      jQuery('#personvalue1').val(value.celular);
        ...
        <script language="JavaScript">
            function aceptar(cedula) {
                opener.document.QForm_comunidad.jefe_comunidad.value=cedula;
                close();
            }
        </script>
    </head>
 ...
 <?php } ?>
    ...
    <table class="container_contenido_cat" border="0" width="100%" cellspacing="0" cellpadding="0">
        <tbody>  			
            <tr>
                <td>
                    <form method="POST" action="centro_acopio_load.php" id="QForm" name="QForm" enctype="multipart/form-data">
