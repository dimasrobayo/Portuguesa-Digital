...
<?php 
    if (isset($_GET['vehiculo'])){
        $datos_borrar= $_GET['vehiculo'];
        
        $query="SELECT * FROM vehiculo_solicitante WHERE vehiculo_solicitante.id_vehiculo ='$datos_borrar' AND vehiculo_solicitante.id_vehiculo NOT IN (SELECT vehiculo_solicitante.id_vehiculo FROM ticket)";
        ...
        if ($total_registros == 1){
            ...
            $result_borrar=pg_query("DELETE FROM vehiculo_solicitante WHERE vehiculo_solicitante.id_vehiculo ='$datos_borrar'") or die(pg_last_error());
            pg_close();
        }
...
<div align="center" class="centermain">
    <div class="main">  
        <table class="adminvehiculos" width="100%">
            <tr>
                <th>
                    VEHÍCULOS:
                </th>
