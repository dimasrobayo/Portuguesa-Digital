    ...
    <div class="main">
        ...
        <form method="POST" action="<?php echo $pagina?>" id="QForm" name="QForm" enctype="multipart/form-data">
            <table class="adminform" border="0" width="100%">
                ...
                <tr>
                    <td class="titulo" colspan="2" height="18"  align="left"><b>Datos de Profesion:</b></td>
                </tr>
                        ...
                        <table class="borded" border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tbody>
                                <tr>
                                    ...
                                    <td>
					                    <input  type="text" id="profesion" name="profesion" value="<?php if ($error!='') echo $profesion;?>" class="validate[required] text-input" size="70" maxlength="70"/>
                                    </td>			
                                </tr>
                            </tbody>
                        </table>	
