                    ...
                    [
                        ...
                        ['<img src="images/iconos/imprimir.png" />',' Reportes',null,null,'Reportes generales del Sistema',
                            ['<img src="images/menu/reporte.png" />', 'Reportes Generales', null, null,
                                _cmSplit,
                                ['<img src="images/iconos/ver_detalle.png" />', 'Tramites de la Unidad', "reportes/imprimir_lista_tramites_unidades.php?cod_unidad=<?php echo $_SESSION['cod_unidad']?>", 'target="_blank"','Tramites de la Unidad'],
                            ...
                            ['<img src="images/menu/reporte.png" />', 'Reportes Específicos', null, null,
                                _cmSplit,
                                ['<img src="images/iconos/ver_detalle.png" />', 'Estadisticos de Ticket por Fecha', "index2.php?view=gestion_reporte_est_unidad_fecha", null,'Estadisticos de Ticket Fecha'],
                                _cmSplit,
                                ['<img src="images/iconos/ver_detalle.png" />', 'Estadisticos de Ticket por Año', "index2.php?view=gestion_reporte_est_unidad_year", null,'Estadisticos de Ticket por Año'],
