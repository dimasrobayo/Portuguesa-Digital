                ...
                <div id="myMenuID">
                    ...
                    [
                        ...
                        ['<img src="images/iconos/file.png" />', 'Archivos', null, null, 'Archivos',
                            ['<img src="images/iconos/config.png" />', 'Configuración del sistema', "index2.php?view=empresa", null, 'Configuración del Sistema'],
                            _cmSplit,
                            ...
                            _cmSplit,
                            ['<img src="images/iconos/mnuclientes.png" />', 'Profesiones', "index2.php?view=profesion_solicitante", null, 'Registro-Profesiones'],     
                            ['<img src="images/iconos/mnurpt_banco.png" />', 'Entes Publicos', "index2.php?view=ente_publico", null, 'Registro-Entes Publicos'],
                            ['<img src="images/iconos/mnupartido.png" />', 'Partido Politico', "index2.php?view=partido_politico", null, 'Registro-Partido Politico'],
                        ],
                        _cmSplit,
                        ...
                        ['<img src="images/iconos/config.png" />', ' Herramientas', null, null, 'Opciones del Sistema',
                            ['<img src="images/iconos/usuarios.png" />', 'Gestionar Usuarios', "index2.php?view=usuarios", null, 'Gestionar los Usuarios del Sistema'],
//                            _cmSplit,
//                            ['<img src="images/menu/mnurespaldo.png" />', 'Mantenimiento de Tickets', "index2.php?view=solicitante_mantenimiento", null, 'Ejecutar Mantenimineto de Tickets'],
//                            ['<img src="images/menu/mnurespaldo.png" />', 'Mantenimiento de Solicitantes', "index2.php?view=solicitante_mantenimiento_phone", null, 'Ejecutar Mantenimineto de Tickets'],
                         ],
