...
//seccion para recibir los datos y borrar.
	...
	if ($total_registros == 1){
            ...
            $result_borrar=pg_query("SELECT drop_banco($datos_borrar)") or die(pg_last_error());
            pg_close();
	}
    }
?> 
