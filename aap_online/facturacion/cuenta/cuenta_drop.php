...
//        echo "<script type='text/javascript'>window.location.href='index.php'</script>";
	...
	$datos_borrar= $_GET['codigo_cuenta'];

	$query = "SELECT * FROM cuenta WHERE cuenta.codigo_cuenta ='$datos_borrar' AND cuenta.n_cuenta IN (SELECT cod_cuenta_banco FROM factura)";			
	...
	if ($total_registros == 1){
            ...
            $result_borrar=pg_query("SELECT drop_cuenta($datos_borrar)") or die(pg_last_error());
            pg_close();
	}
    }
?> 
