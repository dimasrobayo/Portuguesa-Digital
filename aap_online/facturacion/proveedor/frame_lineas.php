<script>
    function eliminar_linea(codfacturatmp,codconcepto,tmonto){
        if (confirm("ESTA CONCEPTO SERA ELIMINADO? ")){
...
<?php
    $query="SELECT * FROM concepto,detalle_facturatmp WHERE detalle_facturatmp.n_factura='$codfacturatmp' AND detalle_facturatmp.codigo_concepto=concepto.codigo_concepto";
    ...
    for ($i = 0; $i < pg_num_rows($result_lineas); $i++) {
        ...
        if ($i % 2) { $fondolinea="itemParTabla"; } else { $fondolinea="itemImparTabla"; } ?>
            <tr class="<?php echo $fondolinea?>">
                <td align="center" width="4%"><?php echo $i+1?></td>
                <td align="center" width="5%"><?php echo $codigo_concepto?></td>
                <td width="49%"><?php echo $nombre_concepto?></td>
                ...
                <td align="center" width="4%">
                    <a href="javascript:eliminar_linea(<?php echo $codfacturatmp?>,<?php echo $codigo_concepto?>,<?php echo $total ?>)">
                        <img src="../../images/cancelar_ticket.png" border="0">
                    </a>
                </td>
            </tr>
    <?php } ?>
