	 ...
	 var methods = {
		...
		*/
		 _ajax: function(field, rules, i, options) {
			 ...
			 //var extraDataDynamic = rule.extraDataDynamic; //Original 			 
            ...
            // Modificaciones Realizadas al Original Ing. Eulicer Gomez
            if (!extraData)
                extraData = "";
            ...
            switch (extraData) {
                case "UserId":                    
						 var data = {
							...
							"fieldValue" : field.val(),
							"extraData" : extraData,
							"extraDataDynamic" : $("#cedula").val(),
							"extraDataDynamic2" : "",
              		   "extraDataDynamicModif" : "",
						 };       		                		  
                   break;
                case "UserName":                    
              		  var data = {
							...
							"fieldValue" : field.val(),
							"extraData" : extraData,
							"extraDataDynamic" : $("#usuarionombre").val(),
							"extraDataDynamic2" : "",
              		   "extraDataDynamicModif" : "",
						 };
                    break;
                case "IglesiaId":                    
              		  var data = {
							...
							"fieldValue" : field.val(),
							"extraData" : extraData,
							"extraDataDynamic" : $("#cod_iglesia_mision").val(),
							"extraDataDynamic2" : "",
              		   "extraDataDynamicModif" : "",
						 };
                    break;
                case "PersonaId":                    
                 ...
                 case "FamiliarId":                    
              		  var data = {
							...
							"extraData" : extraData,
							"extraDataDynamic" : $("#cedula").val(),
							"extraDataDynamic2" : $("#cod_cargafamiliar").val(),
              		   "extraDataDynamicModif" : $("#modificar").val(),
						 };              		  
                    break;
                default:
                		var data = {
			 ...
			 if (!options.isError && !methods._checkAjaxFieldStatus(field.attr("id"), options)) {
				 $.ajax({
					 ...
					 dataType: "json",
					 data: data,
					 //data: "fieldId=" + field.attr("id") + "&fieldValue=" + field.val() + "&extraData=" + extraData + "&extraDataDynamic=" + extraDataDynamic + "&extraDataDynamic2=" + extraDataDynamic2 + "&extraDataDynamicModif=" + extraDataDynamicModif,
					 field: field,
					 rule: rule,
					 methods: methods,
					 options: options,
		...
		*/
		_dateToString: function(date) {
			...
			return date.getDate()+"-"+(date.getMonth()+1)+"-"+date.getFullYear(); /*Agregado por Ing. Eulicer Gomez*/
		},
		/**
		* Parses an ISO date
		* @param {String} d
		*/
		_parseDate: function(d) {
			...
			return new Date(dateParts[2], (dateParts[1] - 1) ,dateParts[0]); /*Agregado por Ing. Eulicer Gomez*/
		},
		/**
