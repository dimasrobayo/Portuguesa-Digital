        ...
        <div class="adminform">
            <div class="cpanel-left">  
                <ul id="divsG" name="divsG" class="shadetabs">
                    ...
                    <li><a href="javascript:void(0);" rel="divG5">Configuraci&oacute;n y Usuarios</a></li>
                    <li><a href="javascript:void(0);" rel="divG6">Reportes</a></li>
                </ul>
                <div style="border:1px solid gray;  margin-bottom: 3px; padding: 7px">
                    <div class="cpanelinicio">
                        ...
                        <div style="display: block;" id="divG5" class="tabcontent">			
                        <table class="borded" border="0" cellpadding="0" cellspacing="1" width="100%">
                        <tbody>
                            <div class="icon-wrapper">
                                <div class="icon">
                        ...
                        <div style="display: block;" id="divG6" class="tabcontent">			
                        <table class="borded" border="0" cellpadding="0" cellspacing="1" width="100%">
                        <tbody>
                            <div class="icon-wrapper">
                                <div class="icon">
