...
//Consulta de Usuarios en linea
    $user =$_SESSION['id'];
    $query="SELECT * FROM usuarios WHERE status_login = 'on' and cedula_usuario <> '$user' order by cedula_usuario";
    $result_user = pg_query($query) or die(pg_last_error());
?>
        ...
        <div class="adminform">
            <div class="cpanel-left">  
                <ul id="divsG" name="divsG" class="shadetabs">
                    <li><a class="selected" href="javascript:void(0);" rel="divG0" >ATENCION AL CIUDADANO</a></li>
                    <li><a href="javascript:void(0);" rel="divG1">MENSAJERIA</a></li>
                    <li><a href="javascript:void(0);" rel="divG2">CONFIGURACION Y USUARIO</a></li>
                </ul>
                ...
                <div style="border:1px solid gray;  margin-bottom: 3px; padding: 7px">
                    <div class="cpanelinicio">
                            ...
                            <div class="icon-wrapper">
                                <div class="icon">
                                    <a href="index2.php?view=tickets">
                                        <img src="images/ticket.png" alt="Administraci&oacute;n de Solicitantes Registrados" align="middle"  border="0" />
                            ...
                            <div class="icon-wrapper">
                                <div class="icon">
                                    <a href="index2.php?view=tipo_solicitantes">
                                        <img src="images/solicitantes_tipo.png" alt="Administraci&oacute;n de Tipos de Solicitantes" align="middle"  border="0" />
                                        <span>Tipo de Solicitantes</span>
                                    </a>
                                </div>
                            </div>
                        </tbody>
                        ...
                        <tbody>
                            <div class="icon-wrapper">
                                <div class="icon">
                                    <a href="index2.php?view=sms_grupo">
                                        <img src="images/sms-grupo.png" alt="Perfil del Usuario" align="middle"  border="0" />
                            ...
                            <div class="icon-wrapper">
                                <div class="icon">
                                    <a href="index2.php?view=sms_recibidos">
                                        <img src="images/sms_recibidos.png" alt="Perfil del Usuario" align="middle"  border="0" />
                            ...
                            <div class="icon-wrapper">
                                <div class="icon">
                                    <a href="index2.php?view=sms_por_enviar">
                                        <img src="images/sms_por_enviar.png" alt="Perfil del Usuario" align="middle"  border="0" />
                                        <span>SMS-Por Enviar</span>
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="icon-wrapper">
                                <div class="icon">
                                    <a href="index2.php?view=sms_enviados">
                                        <img src="images/sms_enviados.png" alt="Perfil del Usuario" align="middle"  border="0" />
                        ...
                        <tbody>
                            <div class="icon-wrapper">
                                <div class="icon">
                                    <a href="index2.php?view=empresa">
                                        <img src="images/icon-48-config.png" alt="Perfil del Usuario" align="middle"  border="0" />
...
//                                                echo '<strong><a title="Ver Detalles" href="?view=solicitantes">'.$resultados_solicitantes_day[0].'</a></strong>';	
                    ...
                    <div id="div_chat">
                        <table class="adminlistpanel">
                            ...
                            <tbody>
                                <?php
                                    while( $resultados_user = pg_fetch_array($result_user)) {
                                   
                                ?>
                                <tr>
                                    <td>
                                        <div class="imgSmall">
                                            <img src="images/fotos/default.jpg" border="0" />
                                        </div>
                                    </td>
                                    
                                    <td>
                                        <a href="#" id="3:5" class="comecar"><?php echo $resultados_user[nombre_usuario] ." " .$resultados_user[apellido_usuario];?></a>
                                    </td>
                                </tr>
                                    <?php }?>
