        ...
        <div class="adminform">
            <div class="cpanel-left">  
                <ul id="divsG" name="divsG" class="shadetabs">
                    <li><a href="javascript:void(0);" rel="divG0">Registro Civil</a></li>
                    <li><a href="javascript:void(0);" rel="divG1">Configuraci&oacute;n y Usuarios</a></li>
                    <li><a href="javascript:void(0);" rel="divG2">Reportes</a></li>
                </ul>
                    ...
                    <div class="cpanelinicio">
                        ...
                        <tbody>
                            <div class="icon-wrapper">
                                <div class="icon">
                                    <div class="icon">
                                        <a href="index2.php?view=registro_online2">
                                            <img src="images/registro_civil.png" alt="registro_civil" align="middle"  border="0" />
                            ...
                            <div class="icon-wrapper">
                                <div class="icon">
                                    <div class="icon">
                                        <a target="true" href="http://200.11.228.3/registro3/solicitudes/fedevida.php">
                                            <img src="images/fe_vida.png" alt="registro_civil" align="middle"  border="0" />
                            ...
                            <div class="icon-wrapper">
                                <div class="icon">
                                    <div class="icon">
                                        <a target="true" href="http://200.11.228.3/registro3/solicitudes/consta_solteria.php">
                                            <img src="images/solteria.png" alt="registro_civil" align="middle"  border="0" />
                                            <span>Solteria</span>
                                        </a>
                                    </div>
                                </div>
                            ...
                            <div class="icon-wrapper">
                                <div class="icon">
                                    <div class="icon">
                                        <a target="true" href="http://www.cne.gob.ve/web/registro_civil/constancia_residencia2.php?">
                                            <img src="images/cne.png" alt="registro_civil" align="middle"  border="0" />
                                            <span>Recidenci CNE</span>
                                        </a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="icon-wrapper">
                                <div class="icon">
                                    <div class="icon">
                                        <a target="true" href="http://200.11.228.3/registro3/solicitudes/presentacion.php">
                                            <img src="images/presentacion.png" alt="registro_civil" align="middle"  border="0" />
                            ...
                            <div class="icon-wrapper">
                                <div class="icon">
                                    <div class="icon">
                                        <a target="true" href="http://200.11.228.3/registro3/solicitudes/citaconcubinato.php">
                                            <img src="images/union_estable.png" alt="registro_civil" align="middle"  border="0" />
                                            <span>Uni&oacute; Estable de Hecho</span>
                                        </a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="icon-wrapper">
                                <div class="icon">
                                    <div class="icon">
                                        <a target="true" href="http://200.11.228.3/registro3/solicitudes/matrimonio.php">
                                            <img src="images/matrimonio.png" alt="registro_civil" align="middle"  border="0" />
